...
def save_model(pipeline, label_mapping, feature_names=None):
    ...
    with open(info_path, 'w') as f:
        ...
        f.write(f"Training samples: {len(pipeline.named_steps['tfidf'].vocabulary_) if hasattr(pipeline.named_steps['tfidf'], 'vocabulary_') else 'N/A'}\n")
        f.write(f"Label distribution: Information, Request, Problem\n")
